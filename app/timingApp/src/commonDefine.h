...
//==============================================================================
  ...
  #define prnRLS(fmt,args...)   printf(fmt,##args)        
    ...
    #define prnM3(fmt,args...)  printf(fmt,##args)       
    #define prnErr()            printf("[ERR] L%d [%s] [F:%s]\n", __LINE__ , __FILE__ , __FUNCTION__)
   #endif

  #ifdef __DEBUG_1__   // Enable printf level 1-3, prnErr, prnMeta
  ...
  #ifdef __DEBUG_2__   // Enable printf level 2-3, prnErr, prnMeta
    #define prnM0(fmt,args...)  
  ...
  #ifdef __DEBUG_3__   // Enable printf level 3, prnErr, prnMeta
    #define prnM0(fmt,args...)  
    #define prnM1(fmt,args...)  
  ...
  #define ifJstRet(args) if(args){prnErr();return;}
#endif
...
typedef struct
{
  ...
  uint tzone;
  double tickPeriod; //12.3076923 ns [81.25MHz]
  tm tmT;
  time_t secPastEpoch;
  uint nsec; //per sec
}drTime_T;
