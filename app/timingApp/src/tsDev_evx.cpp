...
asynStatus tsDev_evx::writeString(const RegMap &rmap, const char *val)
{
  ...
  if(dataType_Trg_Seq == rmap.dataType)
  {
    ...
    else if (strcmp(val, "EXT_IN_SL_08"  ) == 0 ) value = 23;
    else if (strcmp(val, "EXT_IN_SL_09"  ) == 0 ) value = 24;
    else if (strcmp(val, "EXT_IN_SL_10"  ) == 0 ) value = 25;
    else if (strcmp(val, "EXT_IN_SL_11"  ) == 0 ) value = 26;
    else if (strcmp(val, "EXT_IN_SL_12"  ) == 0 ) value = 27;
