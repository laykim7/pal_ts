...
epicsShareExtern void (*pvar_func_timingAsynEpicsRegister)(void);
epicsShareExtern void (*pvar_func_register_func_initStrToValue)(void);
epicsShareExtern void (*pvar_func_register_func_procStrToValue)(void);
...
epicsShareExtern int *pvar_int_timingDebug;
epicsShareExtern int *pvar_int_timingPrintCount;
static struct iocshVarDef vardefs[] = {
	...
	{"timingDebug", iocshArgInt, (void * const)pvar_int_timingDebug},
	{"timingPrintCount", iocshArgInt, (void * const)pvar_int_timingPrintCount},
	{NULL, iocshArgInt, NULL}
};

int timing_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/git/ts_pal_sw/app";
    ...
    (*pvar_func_timingAsynEpicsRegister)();
    (*pvar_func_register_func_initStrToValue)();
    (*pvar_func_register_func_procStrToValue)();
